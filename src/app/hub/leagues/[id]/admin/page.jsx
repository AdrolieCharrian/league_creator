  ...
  return (
    <div className="h-full w-full pt-3">
      <div className="bg-background-light dark:bg-background-dark p-4">
        <h2 className="text-xl mb-4 text-gray-700 dark:text-white">League info</h2>
      ...
      <div className="flex flex-col md:flex-row mt-4">
        <div className="w-full md:w-1/3 p-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl text-gray-700 dark:text-white py-2">Sports</h2>
            <button
        ...
        <div className="w-full md:flex-grow p-4 mt-4 md:mt-0">
          <h2 className="text-xl mb-4 text-gray-700 dark:text-white py-2">Players in league</h2>
          <div className="overflow-y-auto">
            <ul className="space-y-2">
              <li className="p-2 rounded flex justify-between items-center bg-white dark:bg-sidebar-dark text-gray-900 dark:text-gray-100">
                jugador1
      ...
      {showAddSportModal && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white dark:bg-background-dark p-4 rounded-md">
            <h2 className="text-xl mb-4 text-gray-700 dark:text-white">Add Sport</h2>
            <input
              type="text"
      ...
      {showAssignTeamModal && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white dark:bg-background-dark p-4 rounded-md">
            <h2 className="text-xl mb-4 text-gray-700 dark:text-white">Assign Team</h2>
            <input
              type="text"
