    ...
    <div className="container mx-auto my-8 p-4 flex flex-col items-center">
      ...
      <div className="w-full md:w-4/5 xl:w-3/5">
        <form className="flex flex-col items-center" action={!session ? saveProfile : saveProfileGoogle}>
          <label htmlFor="email" className="flex flex-col mt-4 w-full">
            <span className="text-lg ms-4 dark:text-white">Email</span>
          ...
          <label htmlFor="username" className="flex flex-col mt-4 w-full">
            <span className="text-lg ms-4 dark:text-white">Username</span>
            <input id="username" name="username" type="text" defaultValue={checkUsername()}
              className="bg-background-light rounded-full w-full ps-4 py-3 text-sm" />
          </label>
          <label htmlFor="favnumber" className="flex flex-col mt-4 w-full">
            <span className="text-lg ms-4 dark:text-white">Favorite Number</span>
            <input id="favnumber" name="favnumber" type="text" defaultValue={checkFavnumber()}
              className="bg-background-light rounded-full w-full ps-4 py-3 text-sm" />
          </label>
          <label htmlFor="name" className="flex flex-col mt-4 w-full">
            <span className="text-lg ms-4 dark:text-white">Name</span>
            <input id="name" name="name" type="text" defaultValue={checkName()}
              className="bg-background-light rounded-full w-full ps-4 py-3 text-sm" />
          </label>
          <label htmlFor="surname" className="flex flex-col mt-4 w-full">
            <span className="text-lg ms-4 dark:text-white">Surname</span>
          ...
          <label htmlFor="description" className="flex flex-col mt-4 w-full">
            <span className="text-lg ms-4 dark:text-white">Description</span>
          ...
          {token && (
            <div className="w-full">
              <label htmlFor="password" className="flex flex-col mt-4 w-full">
                <span className="text-lg ms-4 dark:text-white">Change Password</span>
              ...
              <label htmlFor="confirm" className="flex flex-col mt-4 w-full">
                <span className="text-lg ms-4 dark:text-white">Confirm Password</span>
