...
const Login = async () => {
  ...
  return (
    <div className="h-screen font-light bg-white dark:bg-background-dark">
      {/* LEFT/BOT SIDE */}
      <div
        className="left-0 flex flex-col items-center pt-2 pb-6 md:text-xl md:h-screen md:absolute md:justify-center
      ...
      >
        ...
        <p className="text-center dark:text-white mb-6 text-4xl w-4/5 pt-8 md:text-7xl md:w-3/5 xl:text-6xl 2xl:text-7xl">
          Login to League Creator
        </p>
        <form
          className="flex items-center justify-center rounded-full bg-background-light border-2 py-3"
          action={async () => {
            "use server";
        ...
        >
          <button
            type="submit"
            className="bg-background-light flex items-center justify-center gap-3 rounded-full
        ...
        <div className="container">
          <form action={login} className="flex flex-col items-center gap-3">
            ...
            <button
              type="submit"
              className="bg-sidebar-light dark:bg-sidebar-dark rounded-full border-2 w-2/5 py-3 xl:w-2/6 dark:text-white"
            >
              Sign In
            </button>
          </form>
      ...
      <div className="relative bg-sidebar-light dark:bg-sidebar-dark flex flex-col items-center justify-center md:absolute right-0 md:h-screen md:w-2/5 xl:w-1/3 z-10">
        <div className="py-8">
          ...
          <div className="flex justify-center">
            <Link
              className="bg-background-light text-center rounded-full border-2 w-1/3 py-3 md:w-2/3 xl:w-3/5"
              href={"/login/register"}
            >
